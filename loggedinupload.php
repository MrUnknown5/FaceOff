...
<body>
        ...
        <div class="container visible-xs-block">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="mobile-signup" href="http://www.faceoff.ml/votenow.php">Vote Now!</a>
                    </li>
                    <li class="sm-80 ">
                            <a href="http://www.faceoff.ml/mytest.php">
                            My Tests!
    ...
    <form action="" method="post" enctype="multipart/form-data" class="mb-3"align="center">
...
while($data = $result->fetch_assoc()){
    // print_r($data);
    $currUser= $data['firstname'];
}
?>

    
    <h3 class="text-center mb-5">Hello <?php echo $currUser ?>! Let's start your photo test.</h3>
    <hr>
        <h3 class="text-center mb-5">Test Your Photo...</h3>
        <div class="container">
        <div class="card">
        <div class="rawcenter user-image mb-3 text-center">
            <div class="rawcenter" style="width: 300px; height: 250px; overflow: hidden; margin: 0.25 auto">
                <img  src="https://drive.google.com/thumbnail?id=1LBUIuwhJKkFQkiO_x-P7Yqu2qQ8lPrm_" class="CenterImage" id="imgPlaceholder" alt="" width=350px height=200px style='text-align:center'></p>
            </div>
        </div>
        </div>
        </div>
        <div class="rawcenter">
            <input class="rawcenter" type="file" name="fileUpload" class="custom-file-input"  id="chooseFile" style='text-align:center'>
            <br/>
            <input class="rawcenter" type="text" name="userTitle" placeholder="Add Title to your photo" style='text-align:center' required>
            <br/>
        </div>
<br/>
...
<!-- Display response messages -->
    ...
    $rawname=$_FILES["fileUpload"]["name"];
    echo $rawname;
