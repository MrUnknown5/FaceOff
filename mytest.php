...
<head>
    ...
    <meta name="description" content="About FaceOff" />
    ...
    <style>
        ...
        *, *:before, *:after {
            ...
            tr {
                ...
                text-align: center;
            background: #f4f7f8;
            border-bottom: 2px solid #ff764d;
            margin-bottom: 5px ;
            }
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="sm-80 hidden-xs">
                        <a href="http://www.faceoff.ml/loggedinupload.php">
                            <div class="btn rawbut">Add New!</div>
                        </a>
                    </li>
                    <li class="hidden-xs">
                        <a href="http://www.faceoff.ml/votenow.php">
                            <div class="btn btn-primary">Vote Now!</div>
                        </a>
                    </li>
                </ul>
            </div>
        ...
        <div class="container visible-xs-block">
            ...
            <div class="collapse navbar-collapse" id="navbar">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a class="mobile-signup" href="http://www.faceoff.ml/sample.php">Vote Now!</a>
                    </li>
                    <li class="sm-80 ">
                        <a href="http://www.faceoff.ml/loggedinupload.php">
                            Add New!
                    ...
                    <li class="sm-80">
                        <a href="http://www.faceoff.ml/logout.php">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
...
<center>
    ...
    <caption>My Tests </caption>
      <thead>
      <tr>
        <th scope="col">Image</th>
        <th scope="col">Title</th>
        <th scope="col">Competent</th>
        <th scope="col">Likable</th>
        <th scope="col">Influential</th>
      ...
      <tfoot>
        <tr>
        <td colspan="3">*Add new photo to get started!<br/></td>
          <td colspan="3">**Data is updated every time you refresh.</td>
        </tr>
      </tfoot>
<?php
session_start();
...
$table='globalimages';
$result=$mysqli->query("SELECT * FROM $table where useremail='$useremail'") or die($mysqli->error); 
while($data = $result->fetch_assoc()){
    $trial= $data['imagename'];
    $votecount=$data['votecount'];
    $competent=round(($data['vote_1_competent']/$votecount)*10,2);
    $likable=round(($data['vote_2_likable']/$votecount)*10,2);
    $influential=round(($data['vote_3_influential']/$votecount)*10,2);
    $overall=round((($competent+$likable+$influential)/3),3);
    ?>
    <tbody>
        <tr>
            <td><img src="<?php echo 'global_images/'.$trial;?>"width="380px" style="visible:hidden" height="250px"/></td>
            <td scope="row"> <strong><u><?php echo $data['usertitle']; ?></u></strong></td>
            <td scope="row"> <strong><?php echo $competent."%"; ?></strong></td>
            <td scope="row"> <strong><?php echo $likable."%"; ?></strong></td>
            <td scope="row"> <strong><?php echo $influential."%"; ?></strong></td>
            <td scope="row"> <strong><?php echo $overall."%"; ?></strong></td>
            <td scope="row"> <a class="btn rawbut" href="delete-process.php?deleteid=<?php echo $trial; ?>">Delete</a></td>
        </tr>
        </tbody>
...
<footer>
    ...
    <script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam-cell.nr-data.net","licenseKey":"ecbe44911a","applicationID":"35958959","transactionName":"M1MHZUZZW0RWVURZDQoZMENdF1RVWENEHhIMRg==","queueTime":0,"applicationTime":39,"atts":"HxQEEw5DSEo=","errorBeacon":"bam-cell.nr-data.net","agent":""}</script>
</body>
</html>
